...
${TESTDIR}/instLireTestRunner.o: instLireTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/instLireTestRunner.o instLireTestRunner.cpp


${TESTDIR}/testNoeudInstLire.o: testNoeudInstLire.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testNoeudInstLire.o testNoeudInstLire.cpp
