...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_cpp

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_cpp: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_cpp ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${TESTDIR}/mainTestInterpreteurAnaLyse.o: mainTestInterpreteurAnaLyse.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/mainTestInterpreteurAnaLyse.o mainTestInterpreteurAnaLyse.cpp


${TESTDIR}/testInterpreteurAnalyse.o: testInterpreteurAnalyse.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testInterpreteurAnalyse.o testInterpreteurAnalyse.cpp
